...
if msg[1] == "\"чс" and (sender == "Высшая" or sender == "Ваймс" or sender == "Хефе" or sender == "Дервин" or sender == "Люцзе" or sender == "Посети" or sender == "Витинари" or sender == "Злойкакаш" or sender == "Анхулик" or sender == "Qoshadows" or sender == "Хилялко" or sender == "Сантанигга" or sender == "Кусяо" or sender == "Колон" or sender == "Кербес" or sender == "Аффа" or sender == "Шеф" or sender == "Нугган" or sender == "Showmeblood" or sender == "Годвар" or sender == "Совамилаха") then
