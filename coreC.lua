...
if msg[1] == "\"чс" and (sender == "Высшая" or sender == "Ваймс" or sender == "Хефе" or sender == "Дервин" or sender == "Люцзе" or sender == "Посети" or sender == "Витинари" or sender == "Злойкакаш" or sender == "Анхулик" or sender == "Qoshadows" or sender == "Хилялко" or sender == "Сантанигга" or sender == "Кусяо" or sender == "Колон" or sender == "Кербес" or sender == "Аффа" or sender == "Шеф" or sender == "Нугган" or sender == "Showmeblood" or sender == "Годвар" or sender == "Zogtar") then
...
"[__8__]",
-- ==========================================
-- СЕРДЦЕВИНА / ДЕТАЛИ (только 8 в центре)
-- ==========================================
...
-- === Смешанные (разные символы внутри) ===
"[_._]",
"(_._)",
"{_._}",
    ...
    -- Делить (уникальный из 2-го списка)
    "[ ÷ Y ÷ ]",         -- центр
    "[ ÷ Y ÷]",          -- левее
    "[÷ Y ÷ ]",          -- правее
    "[ ÷Y ÷ ]",          -- ещё левее
    ...
    -- Умножить (уникальный из 2-го списка)
    "{ × Y × }",         -- центр
    "{ × Y ×}",          -- левее
    "{× Y × }",          -- правее
    "{ ×Y × }",          -- ещё левее
    ...
    -- ==========================================
    -- ТРОЙНЫЕ И МУЛЬТИ-ВАРИАНТЫ (из 1-го списка)
    -- ==========================================
    -- Без Y
    "(.)(.)(.)",
    "(o)(o)(o)",
