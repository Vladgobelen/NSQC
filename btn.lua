...
function vybor:configure(id)
	...
	vybor[id]:SetScript("OnEnter",function(self)
		...
		if mioFld1 ~= nil then
			if mioFld1[nome]["объекты"][tostring(testQ["idp"])] == "zt" and id == 4 and tonumber(testQ["brevna"]) >= 10 and tonumber(testQ["kamen"]) >= 20 then
				GameTooltip:SetOwner(self, "ANCHOR_RIGHT")
				GameTooltip:AddLine("Построить бетонный завод")
				GameTooltip:Show()
			end
			if mioFld1[nome]["объекты"][tostring(testQ["idp"])] == "zt" and id == 4 and tonumber(testQ["brevna"]) < 10 then
				GameTooltip:SetOwner(self, "ANCHOR_RIGHT")
				GameTooltip:AddLine("Нужно 10 бревен")
				GameTooltip:Show()
			end
			if mioFld1[nome]["объекты"][tostring(testQ["idp"])] == "zt" and id == 4 and tonumber(testQ["kamen"]) < 20 then
				GameTooltip:SetOwner(self, "ANCHOR_RIGHT")
						...
						if	mioFld1[nome]["объекты"][tostring(id)] == "dz" then
							...
							if nome == myNome then
								if testQ[myNome]["hTimer"] == nil then
									...
									if testQ['q3dict'] == nil and testQ[myNome]["взятый_квест_х"] == "itemQ" then
										if testQ[myNome]["itemQend"] ~= 1 then
											testQ["okno"] = "itemQ"
											quesT("show")
											okNo:configure(1,"show")
									...
									if testQ[myNome]["взятый_квест_х"] == nil or testQ[myNome]["взятый_квест_х"] == "9999" and testQ[myNome]["взятый_квест_s"] == nil and testQ['q3dict'] == nil then
										local qq
											while true do
												qq=math.random(1,#pQuest["items"])
		...
		if mioFld1 ~= nil then
			if mioFld1[nome] ~= nil then
				...
				if mioFld1[nome]["объекты"][tostring(id)] == "m1" then
					...
					if mioFld1[nome]["целостность"][tostring(id)] ~= nil and tonumber(mioFld1[nome]["целостность"][tostring(id)]) < 999 then
						num1 = 1
					end
				end
				if mioFld1[nome]["объекты"][tostring(id)] == "uz" then
				...
				if mioFld1[nome]["объекты"][tostring(id)] == "bn" then
					...
					if mioFld1[nome]["целостность"][tostring(id)] ~= nil and tonumber(mioFld1[nome]["целостность"][tostring(id)]) < 4999 then
						num1 = 1
					end
				end
				if mioFld1[nome]["объекты"][tostring(id)] == "sx" then
					...
					if mioFld1[nome]["целостность"][tostring(id)] ~= nil and tonumber(mioFld1[nome]["целостность"][tostring(id)]) < 14999 then
						num1 = 1
					end
				end
				if mioFld1[nome]["объекты"][tostring(id)] == "hs" then
				...
				if mioFld1[nome]["объекты"][tostring(id)] == "za" and tonumber(testQ["kamen"]) < 1 then
...
-- 						if mioFld1[myNome]["объекты"][tostring(i)] == "f" then
					...
					if mioFld1[myNome] ~= nil then
						if mioFld1[myNome]["петы"] ~= nil then
							if mioFld1[myNome]["объекты"][tostring(i)] == "t" and mioFld1[myNome]["петы"][tostring(i)] == "bb" then
								...
								mioFld1[myNome]["целостность"][tostring(i)] = 1
								...
								if testQ ~= nil then
									local testB = nil
									for i = 1,100 do
										if mioFld1[myNome]["объекты"][tostring(i)] == "sb" then
											if testB == nil then
												testB = 1
											else
												testB = testB + 1
	...
	if timeElapsed > 1 then
		...
		if mioFld1 ~= nil then
			if testQ["zarplata"] ~= nil then
				for i = 1, 100 do
					if mioFld1[myNome]["петы"] ~= nil then
						if mioFld1[myNome]["объекты"][tostring(i)] == "m" and mioFld1[myNome]["петы"][tostring(i)] == "gom" then
							local x = math.random(1,2)
							if x == 2 then
								local xx = math.random(1,500)
								gKam(myNome,xx)
						...
						if mioFld1[myNome]["объекты"][tostring(i)] == "m" and mioFld1[myNome]["петы"][tostring(i)] == "gob" then
							local xx = math.random(1,500)
							gKam(myNome,xx)
							fBtn[i]:SetNormalTexture("Interface\\AddOns\\NSQC\\libs\\gobZ.tga")
						end
					end
					if (mioFld1[myNome]["объекты"][tostring(i)] == "mx" or mioFld1[myNome]["объекты"][tostring(i)] == "hs" or mioFld1[myNome]["объекты"][tostring(i)] == "ms" or mioFld1[myNome]["объекты"][tostring(i)] == "uz" or mioFld1[myNome]["объекты"][tostring(i)] == "zs" or mioFld1[myNome]["объекты"][tostring(i)] == "zx" or mioFld1[myNome]["объекты"][tostring(i)] == "skc" or mioFld1[myNome]["объекты"][tostring(i)] == "sx" or mioFld1[myNome]["объекты"][tostring(i)] == "bc") and mioFld1[myNome]["петы"][tostring(i)] == "gom" then
						local xxx = math.random(1,2)
						if xxx == 2 then
							for j = 1, 500 do
								if j == 500 then
					...
					if (mioFld1[myNome]["объекты"][tostring(i)] == "mx" or mioFld1[myNome]["объекты"][tostring(i)] == "hs" or mioFld1[myNome]["объекты"][tostring(i)] == "ms" or mioFld1[myNome]["объекты"][tostring(i)] == "uz" or mioFld1[myNome]["объекты"][tostring(i)] == "zs" or mioFld1[myNome]["объекты"][tostring(i)] == "zx" or mioFld1[myNome]["объекты"][tostring(i)] == "skc" or mioFld1[myNome]["объекты"][tostring(i)] == "sx" or mioFld1[myNome]["объекты"][tostring(i)] == "bc") and mioFld1[myNome]["петы"][tostring(i)] == "gob" then
						for j = 1, 500 do
							if j == 500 then
								resObj(i,myNome,myNome)
							end
				...
				if tonumber(testQ["zarplata"]) <= 0 then
					testQ["zarplata"] = nil
					for i = 1, 100 do
						if mioFld1[myNome]["объекты"][tostring(i)] == "m" then
...
myCheckButton8.tooltip = "ПКМ: переключение режимов";
myCheckButton8:RegisterForClicks("LeftButtonUp", "RightButtonDown")
