	...
	vybor[id]:SetScript("OnClick",function(self)
		...
		if mioFld[nome]["объекты"][tostring(testQ["idp"])] == "t" and id == 8 then
			if testQ["temp"] == nil then
				...
				testQ["temp"] = 1
			elseif testQ["temp"] == 1 then
				PlaySoundFile("Interface\\AddOns\\NSQC\\libs\\bb.ogg")
							...
							elseif tonumber(testQ["mioFldLvl"]) == 2 then
								if testQ[myNome]["hTimer"] == nil then
									if testQ[myNome]["dTimer"][tonumber(date("%d"))-1] == nil and testQ[myNome]["dTimer"][30] == nil then
										...
										if tonumber(date("%d")) ~= 1 then
											if testQ[myNome]["dTimer"][tonumber(date("%d"))-1] > 3600 then
												testQ[myNome]["hTimer"] = (testQ[myNome]["dTimer"][tonumber(date("%d"))-1])/2
											else
												testQ[myNome]["hTimer"] = 3600
											end
										else
											if testQ[myNome]["dTimer"][30] ~= nil and testQ[myNome]["dTimer"][30] > 3600 then
												testQ[myNome]["hTimer"] = (testQ[myNome]["dTimer"][30])/2
											else
												testQ[myNome]["hTimer"] = 3600
											end
										end
							...
							elseif tonumber(testQ["mioFldLvl"]) == 3 then
								if testQ[myNome]["hTimer"] == nil then
									if testQ[myNome]["dTimer"][tonumber(date("%d"))-1] == nil and testQ[myNome]["dTimer"][30] == nil then
										...
										if tonumber(date("%d")) ~= 1 then
											if testQ[myNome]["dTimer"][tonumber(date("%d"))-1] > 3600 then
												testQ[myNome]["hTimer"] = (testQ[myNome]["dTimer"][tonumber(date("%d"))-1])/3
											else
												testQ[myNome]["hTimer"] = 3600
											end
										else
											if testQ[myNome]["dTimer"][30] ~= nil and testQ[myNome]["dTimer"][30] > 3600 then
												testQ[myNome]["hTimer"] = (testQ[myNome]["dTimer"][30])/3
											else
												testQ[myNome]["hTimer"] = 3600
											end
										end
							...
							elseif tonumber(testQ["mioFldLvl"]) == 4 then
								if testQ[myNome]["hTimer"] == nil then
									if testQ[myNome]["dTimer"][tonumber(date("%d"))-1] == nil and testQ[myNome]["dTimer"][30] == nil then
										...
										if tonumber(date("%d")) ~= 1 then
											if testQ[myNome]["dTimer"][tonumber(date("%d"))-1] > 3600 then
												testQ[myNome]["hTimer"] = (testQ[myNome]["dTimer"][tonumber(date("%d"))-1])/4
											else
												testQ[myNome]["hTimer"] = 3600
											end
										else
											if testQ[myNome]["dTimer"][30] ~= nil and testQ[myNome]["dTimer"][30] > 3600 then
												testQ[myNome]["hTimer"] = (testQ[myNome]["dTimer"][30])/4
											else
												testQ[myNome]["hTimer"] = 3600
											end
										end
							...
							elseif tonumber(testQ["mioFldLvl"]) == 5 then
								if testQ[myNome]["hTimer"] == nil then
									if testQ[myNome]["dTimer"][tonumber(date("%d"))-1] == nil and testQ[myNome]["dTimer"][30] == nil then
										...
										if tonumber(date("%d")) ~= 1 then
											if testQ[myNome]["dTimer"][tonumber(date("%d"))-1] > 3600 then
												testQ[myNome]["hTimer"] = (testQ[myNome]["dTimer"][tonumber(date("%d"))-1])/5
											else
												testQ[myNome]["hTimer"] = 3600
											end
										else
											if testQ[myNome]["dTimer"][30] ~= nil and testQ[myNome]["dTimer"][30] > 3600 then
												testQ[myNome]["hTimer"] = (testQ[myNome]["dTimer"][30])/5
											else
												testQ[myNome]["hTimer"] = 3600
											end
										end
							...
							elseif tonumber(testQ["mioFldLvl"]) == 6 then
								if testQ[myNome]["hTimer"] == nil then
									if testQ[myNome]["dTimer"][tonumber(date("%d"))-1] == nil and testQ[myNome]["dTimer"][30] == nil then
										...
										if tonumber(date("%d")) ~= 1 then
											if testQ[myNome]["dTimer"][tonumber(date("%d"))-1] > 3600 then
												testQ[myNome]["hTimer"] = (testQ[myNome]["dTimer"][tonumber(date("%d"))-1])/6
											else
												testQ[myNome]["hTimer"] = 3600
											end
										else
											if testQ[myNome]["dTimer"][30] ~= nil and testQ[myNome]["dTimer"][30] > 3600 then
												testQ[myNome]["hTimer"] = (testQ[myNome]["dTimer"][30])/6
											else
												testQ[myNome]["hTimer"] = 3600
											end
										end
							...
							elseif tonumber(testQ["mioFldLvl"]) == 7 then
								if testQ[myNome]["hTimer"] == nil then
									if testQ[myNome]["dTimer"][tonumber(date("%d"))-1] == nil and testQ[myNome]["dTimer"][30] == nil then
										...
										if tonumber(date("%d")) ~= 1 then
											if testQ[myNome]["dTimer"][tonumber(date("%d"))-1] > 3600 then
												testQ[myNome]["hTimer"] = (testQ[myNome]["dTimer"][tonumber(date("%d"))-1])/7
											else
												testQ[myNome]["hTimer"] = 3600
											end
										else
											if testQ[myNome]["dTimer"][30] ~= nil and testQ[myNome]["dTimer"][30] > 3600 then
												testQ[myNome]["hTimer"] = (testQ[myNome]["dTimer"][30])/7
											else
												testQ[myNome]["hTimer"] = 3600
											end
										end
					...
					if testQ["fRand3"] == 1 then
						...
						if testQ["fRand3Nome"] == nome then
							if fBtn[1] ~= nil or fBtn[1]:IsVisible() then
								for i = 1,100 do
									if mioFld[testQ["fRand3Nome"]]["объекты"][tostring(i)] ~= "hs" and mioFld[testQ["fRand3Nome"]]["объекты"][tostring(i)] ~= "zs" then
					...
					if testQ["fRand5"] == 1 then
						...
						if nome == testQ["fRand5Nome"] then
							if fBtn[1] ~= nil or fBtn[1]:IsVisible() then
								for i = 1,100 do
									j = tostring(i)
									if mioFld[testQ["fRand5Nome"]]["объекты"][tostring(i)] ~= "hs" or mioFld[testQ["fRand5Nome"]]["объекты"][tostring(i)] ~= "zs" or mioFld[testQ["fRand5Nome"]]["объекты"][tostring(i)] ~= "zx" then
