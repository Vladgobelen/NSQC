...
if kodMsg[1] == "dostPOL" and kodMsg[2] == myNome then
	...
	if message == "3" then
		--SendChatMessage("Возле Обелиска я нахожу давно забытую технологию: Топор *оглядывается в поисках других игроков*", "OFFICER", nil, 1)
...
if kodMsg[1] == "ns_tuC" and msg[2] == myNome then
	mioFld1[msg[1]]["целостность"][tostring(kodMsg[2])] = tonumber(kodMsg[3])
	dmgText(kodMsg[3],fBtn[tonumber(kodMsg[2])],tonumber(kodMsg[2]),13,"FF8C00")
	dmG[tonumber(kodMsg[2])]:Show()
end
if kodMsg[1] == "ns_pstrMZ" and msg[1] == myNome then
...
if kodMsg[1] == "ns_pstrH" and msg[1] == myNome then
