...
if kod=="NSGadd" then
if string.find (message, "#aaa") and string.find (message, myNome) then
...
if string.find (message, "#aah") and string.find (message, myNome) then
...
local myNome = GetUnitName("player")
if string.find (message, "#aae") and string.find (message, myNome) then
