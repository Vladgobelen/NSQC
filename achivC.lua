...
if kodMsg[1] == "ns_tuC" and msg[2] == myNome then
	mioFld1[msg[1]]["целостность"][tostring(kodMsg[2])] = tonumber(numeCod(kodMsg[3]))
	dmgText(tonumber(numeCod(kodMsg[3])),fBtn[tonumber(kodMsg[2])],tonumber(kodMsg[2]),13,"FF8C00")
