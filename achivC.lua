		...
		if testQ['np_inviz'] ~= nil then
			if UnitAffectingCombat("player") == 1 then
				...
				if testQ['np_inviz'] == nil then
					...
					unIcon(1000,100,6,1,-44,"rage0","show",sBtn[1],"BOTTOMLEFT","TOPLEFT")
					unT[1000]:SetFrameStrata("FULLSCREEN")
				end
				unIcon(1030,healthRez,6,1,-44,"rage","show",sBtn[1],"BOTTOMLEFT","TOPLEFT")
				...
				if testQ['np_inviz'] == nil then
					...
					unIcon(12999,100,6,1,-4,"rage0","show",sBtn[1],"BOTTOMLEFT","TOPLEFT")
				...
				if (UnitClass("player") == "Разбойник" or UnitClass("player") == "Разбойница") or dru == 1 then
					if testQ['np_inviz'] == nil then
						...
						unIcon(1005,manaRez,6,1,-4,"rage5","show",sBtn[1],"BOTTOMLEFT","TOPLEFT")
					end
				...
				if UnitClass("player") == "Воин" or dru == 2 then
					if testQ['np_inviz'] == nil then
						...
						unIcon(1005,manaRez,6,1,-4,"rage1","show",sBtn[1],"BOTTOMLEFT","TOPLEFT")
					end
